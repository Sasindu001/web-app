...
public class MainController {
    ...
    */
    ...
    public @ResponseBody String addNewCartItem(@RequestParam String pname, @RequestParam int quantity, @RequestParam double fprice, @RequestParam String imageUrl)
    {
        Cart cart = new Cart();
        cart.setPname(pname);
    ...
    public @ResponseBody List<Cart> updateCartDetails(@RequestParam String pname, @RequestParam int quantity, @RequestParam double fprice)
    {
        ...
        if(!cartDetailsList.isEmpty()){
            for(Cart cartDetails: cartDetailsList){
                ...
                //cartDetails.setImageUrl(imageUrl);
